...
import static it.unimib.fipavonline.util.Constants.EMAIL_ADDRESS;
...
import static it.unimib.fipavonline.util.Constants.MINIMUM_PASSWORD_LENGTH;
import static it.unimib.fipavonline.util.Constants.PASSWORD;
import static it.unimib.fipavonline.util.Constants.USER_COLLISION_ERROR;
import static it.unimib.fipavonline.util.Constants.WEAK_PASSWORD_ERROR;
...
import it.unimib.fipavonline.databinding.FragmentRegistrationBinding;
